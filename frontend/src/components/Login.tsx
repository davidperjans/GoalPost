  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (err.response) {
        ...
        setError(err.response.data.message || 'Ett fel uppstod vid inloggning');
      } else if (err.request) {
      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form className="w-full max-w-md p-8 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-lg" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <Link to="/register" className="text-sm text-green-500 hover:underline dark:text-green-400">
